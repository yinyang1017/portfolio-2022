...
import { Address, Link, ProfileData } from "../types";
...
const Home: NextPage<Props> = ({ profileData, links, address }) => {
...
export async function getStaticProps() {
  ...
  const { data: address } = await client.query({
    query: profileOperations.Queries.getAddress,
  });
  return {
    props: {
